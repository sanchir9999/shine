        ...
        <div className="w-[1440px] m-auto border-solid border-amber-500 border-2">
            <div className="w-[1280px] m-auto flex flex-col items-center gap-[50px]">
                <div className="w-[1216px] m-auto flex flex-col items-center gap-[16px]">
                    <div className="w-[119px] h-[28px] rounded-md text-sm bg-slate-200 text-black flex items-center justify-center">Get in touch</div>
                    <div className="font-normal text-xl text-center">What’s next? Feel free to reach out to me if you're looking for <br></br>
                ...
                <div className="w-[436px] flex flex-col items-center">
                    <div className="flex justify-center gap-[26px]">
                        <div> <Messege /> </div>
                        <div className="font-semibold text-4xl">Monhbatsanchir1@gmail.com</div>
                        <div> <Suren /> </div>
                    </div>``
                    <div className="flex ">
                        <div> <Phone /> </div>
                        <div className="font-semibold text-4xl">+97688175658</div>
                        <div> <Suren /> </div>
                    </div>
                </div>
