export const SecondSection = () => {
    return (
        <div className="w-[full] bg-slate-50 dark:bg-[#111827] pl-[80px] pr-[80px] pt-[96px] pb-[96px]">
            <div className="w-[1440px] m-auto bg-slate-50 dark:bg-[#111827]">
                <div className=" flex flex-col gap-[48px]">
                    ...
                    <div className="flex">
                        ...
                        <div className="flex-1 flex flex-col gap-[24px]">
                            <div className="text-3xl font-semibold text-[#000] dark:text-[#D1D5DB]">Curious about me? Here you have it:</div>
                            <div className=" flex flex-col gap-[16px] font-normal text-base text-[#000] dark:text-[#D1D5DB]">
                                ...
                                <ul className="flex flex-col gap-[16px] list-disc text-[#000] dark:text-[#D1D5DB]">
                                    <li>B.E. in Computer Engineering</li>
                                    <li>Avid learner</li>
                                    <li>Full time freelancer</li>
                                </ul>
                                <p className="text-[#000] dark:text-[#D1D5DB]">One last thing, I'm available for freelance work, so feel free to reach out and say hello! I promise I don't bite 😉</p>
                            </div>
                        </div>
                    </div>
                </div>
